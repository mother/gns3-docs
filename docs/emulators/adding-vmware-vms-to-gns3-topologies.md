...
![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/1.jpg)

In VMware Workstation, click **“Create a New Virtual Machine”**:

![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/2.jpg)

Follow the VMware Wizard to import create the new virtual machine. In the first step, select **Typical** and then click **Next >**:

![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/3.jpg)

Point to the ISO file downloaded and click **Next >**:

![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/4.jpg)

Select **Linux** as the **Guest operating system** and **Other Linux 4.x** as the Version and then click **Next >**:

![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/5.jpg)
...
![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/6.jpg)
...
![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/7.jpg)

Click **Customize Hardware**:

![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/8.jpg)
...
![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/9.jpg)

To complete the VM import, click **Finish**:

![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/10.jpg)

The VM is now available in VMware Workstation:

![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/11.jpg)

Power on the virtual machine in VMware Workstation:

![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/12.jpg)
...
![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/13.jpg)
...
![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/14.jpg)
...
![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/15.jpg)
...
![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/16.jpg)

Click **Edit** and then **Preferences**:

![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/17.jpg)

Click **VMware VMs** and **New**, to add a new VMware virtual machine:

![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/18.jpg)
...
![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/19.jpg)

On the next screen, click on the dropdown:

![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/20.jpg)
...
![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/21.jpg)

Click **Finish>** to complete the import process:

![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/22.jpg)
...
![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/23.jpg)

Click the **Network** Tab:

![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/24.jpg)
...
![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/25.jpg)
...
![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/26.jpg)
...
![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/27.jpg)
...
![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/28.jpg)
...
![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/29.jpg)

The new virtual machine is now available to be added to a GNS3 topology:

![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/30.jpg)
...
![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/31.jpg)
...
![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/32.jpg)

Click the **Toolbar Device** button again to collapse the group:

![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/33.jpg)
...
![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/34.jpg)
...
![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/35.jpg)
...
![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/36.jpg)
...
![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/37.jpg)

Click the **Show/Hide interface labels** button on the **GNS3 Toolbar** to display interface labels in your topology:

![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/38.jpg)

This will display the connected interfaces of both devices:

![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/39.jpg)
...
![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/40.jpg)

GNS3 indicates that the devices have been powered on by turning the interface connectors from red to green:

![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/41.jpg)
...
![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/42.jpg)
...
![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/43.jpg)
...
![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/44.jpg)
...
![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/45.jpg)

Click **Network**:

![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/46.jpg)

Configure the relevant IP addressing information and click **Apply** and then Exit:

![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/47.jpg)
...
![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/48.jpg)
...
![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/49.jpg)

Click on the **Terminal** icon at the bottom of the TinyCore GUI to open a terminal:

![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/50.jpg)
![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/51.jpg)

(a terminal is now open)
Ping R1 from the TinyCore PC:

![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/52.jpg)
...
![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/53.jpg)

When you first created the TinyCore-Local-VMware virtual machine, it was set to use a NAT (VMnet 8) by default:

![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/54.jpg)
...
![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/55.jpg)
...
![screenshot](/img/emulators/adding-vmware-vms-to-gns3-topologies/56.jpg)
