...
![screenshot](/img/getting-started/setup-wizard-local-server/1.jpg)
...
![screenshot](/img/getting-started/setup-wizard-local-server/2.jpg)
...
![screenshot](/img/getting-started/setup-wizard-local-server/3.jpg)


## Using the GNS3 Setup Wizard
Select **"Run appliances on my local computer"** in the Wizard and click **'Next >'**:

![screenshot](/img/getting-started/setup-wizard-local-server/4.jpg)
...
![screenshot](/img/getting-started/setup-wizard-local-server/5.jpg)
...
![screenshot](/img/getting-started/setup-wizard-local-server/6.jpg)
...
![screenshot](/img/getting-started/setup-wizard-local-server/7.jpg)
...
![screenshot](/img/getting-started/setup-wizard-local-server/8.jpg)

In the preferences menu, select **'IOS Routers and New'**, to begin the process of importing an image.

![screenshot](/img/getting-started/setup-wizard-local-server/9.jpg)
...
![screenshot](/img/getting-started/setup-wizard-local-server/10.jpg)
...
![screenshot](/img/getting-started/setup-wizard-local-server/11.jpg)

Browse to the folder where you have stored your Cisco IOS images, select the image,  and click **'Open'**:

![screenshot](/img/getting-started/setup-wizard-local-server/12.jpg)
...
![screenshot](/img/getting-started/setup-wizard-local-server/16.jpg)
...
![screenshot](/img/getting-started/setup-wizard-local-server/17.jpg)

Click **Search for Image(s)**:

![screenshot](/img/getting-started/setup-wizard-local-server/18.jpg)

The minimum DRAM requirements for the IOS are displayed. Note the value for your IOS image:

![screenshot](/img/getting-started/setup-wizard-local-server/19.jpg)
...
![screenshot](/img/getting-started/setup-wizard-local-server/20.jpg)
...
![screenshot](/img/getting-started/setup-wizard-local-server/21.jpg)
...
![screenshot](/img/getting-started/setup-wizard-local-server/22.jpg)
...
![screenshot](/img/getting-started/setup-wizard-local-server/23.jpg)

If a green Idle-PC value is NOT shown then click the **'Idle-PC finder'** button to find an Idle-PC value:

![screenshot](/img/getting-started/setup-wizard-local-server/24.jpg)
...
![screenshot](/img/getting-started/setup-wizard-local-server/25.jpg)

(note, this may take a few moments, depending on the speed of your PC)
An Idle-PC value is displayed. Click **'OK'** to complete:

![screenshot](/img/getting-started/setup-wizard-local-server/26.jpg)
...
![screenshot](/img/getting-started/setup-wizard-local-server/27.jpg)
...
![screenshot](/img/getting-started/setup-wizard-local-server/28.jpg)
...
![screenshot](/img/getting-started/setup-wizard-local-server/29.jpg)

The GNS3 workspace displays:

![screenshot](/img/getting-started/setup-wizard-local-server/30.jpg)
