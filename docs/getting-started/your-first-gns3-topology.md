...
![screenshot](/img/getting-started/your-first-gns3-topology/1.jpg)

Name the project as desired and then click **OK**:

![screenshot](/img/getting-started/your-first-gns3-topology/2.jpg)
...
![screenshot](/img/getting-started/your-first-gns3-topology/3.jpg)

### GNS3 Workspace

The GNS3 workspace is the area of GNS3 where you create topologies by adding devices and links:

![screenshot](/img/getting-started/your-first-gns3-topology/4.jpg)
...
![screenshot](/img/getting-started/your-first-gns3-topology/5.jpg)
...
![screenshot](/img/getting-started/your-first-gns3-topology/6.jpg)

The devices toolbar is grouped into different types by default:

| Tool | Name |
| ---- | ---- |
| ![screenshot](/img/getting-started/your-first-gns3-topology/7.jpg) | Routers |
| ![screenshot](/img/getting-started/your-first-gns3-topology/8.jpg) | Switches |
| ![screenshot](/img/getting-started/your-first-gns3-topology/9.jpg) | End Devices |
| ![screenshot](/img/getting-started/your-first-gns3-topology/10.jpg) | Security Devices |
| ![screenshot](/img/getting-started/your-first-gns3-topology/11.jpg) | All Devices |
| ![screenshot](/img/getting-started/your-first-gns3-topology/12.jpg) | Add a link |
...
![screenshot](/img/getting-started/your-first-gns3-topology/13.jpg)
...
![screenshot](/img/getting-started/your-first-gns3-topology/14.jpg)
...
![screenshot](/img/getting-started/your-first-gns3-topology/15.jpg)
...
![screenshot](/img/getting-started/your-first-gns3-topology/16.jpg)
...
![screenshot](/img/getting-started/your-first-gns3-topology/17.jpg)
...
![screenshot](/img/getting-started/your-first-gns3-topology/18.jpg)
...
![screenshot](/img/getting-started/your-first-gns3-topology/19.jpg)
...
![screenshot](/img/getting-started/your-first-gns3-topology/20.jpg)

The above image is listing the name of the PC, indicating that you’d like to run this node via the local server.

![screenshot](/img/getting-started/your-first-gns3-topology/21.jpg)
...
![screenshot](/img/getting-started/your-first-gns3-topology/22.jpg)

To collapse the **Browse End Devices** toolbar, either click the **Browse End Devices** button again, or click the X shown below:

![screenshot](/img/getting-started/your-first-gns3-topology/23.jpg)
...
![screenshot](/img/getting-started/your-first-gns3-topology/24.jpg)
...
![screenshot](/img/getting-started/your-first-gns3-topology/25.jpg)
...
![screenshot](/img/getting-started/your-first-gns3-topology/26.jpg)

Click Ethernet0 on PC-1, and then left-click on Ethernetswitch-1:

![screenshot](/img/getting-started/your-first-gns3-topology/27.jpg)
...
![screenshot](/img/getting-started/your-first-gns3-topology/28.jpg)
...
![screenshot](/img/getting-started/your-first-gns3-topology/29.jpg)
...
![screenshot](/img/getting-started/your-first-gns3-topology/30.jpg)
...
![screenshot](/img/getting-started/your-first-gns3-topology/31.jpg)
...
![screenshot](/img/getting-started/your-first-gns3-topology/32.jpg)
...
![screenshot](/img/getting-started/your-first-gns3-topology/33.jpg)

This is also reflected in the **Topology Summary**.

![screenshot](/img/getting-started/your-first-gns3-topology/34.jpg)
...
![screenshot](/img/getting-started/your-first-gns3-topology/35.jpg)
...
![screenshot](/img/getting-started/your-first-gns3-topology/36.jpg)
...
![screenshot](/img/getting-started/your-first-gns3-topology/37.jpg)
...
![screenshot](/img/getting-started/your-first-gns3-topology/38.jpg)
...
![screenshot](/img/getting-started/your-first-gns3-topology/39.jpg)

That will open a new third tab in Solar-Putty for us:

![screenshot](/img/getting-started/your-first-gns3-topology/40.jpg)
