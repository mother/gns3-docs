...
![screenshot](/img/getting-started/installation/esxi/1.jpg)

Choose ”Deploy a virtual machine from an OVF or OVA file”

![screenshot](/img/getting-started/installation/esxi/2.jpg)

 Enter the name and upload the .ova of the GNS3 or if your OS unzip the OVA when extract the zip all the files:

![screenshot](/img/getting-started/installation/esxi/3.jpg)

Select the datastore of your choice and continue.

![screenshot](/img/getting-started/installation/esxi/4.jpg)

![screenshot](/img/getting-started/installation/esxi/5.jpg)

At the end of wizard wait for disk upload:

![screenshot](/img/getting-started/installation/esxi/6.jpg)

### Nested virtualization
After booting the VM you will see that KVM is not available:

![screenshot](/img/getting-started/installation/esxi/7.jpg)
...
![screenshot](/img/getting-started/installation/esxi/8.jpg)
...
![screenshot](/img/getting-started/installation/esxi/9.jpg)

And accept everything:

![screenshot](/img/getting-started/installation/esxi/10.jpg)

Edit the VM settings to use the new network:

![screenshot](/img/getting-started/installation/esxi/11.jpg)
...
![screenshot](/img/getting-started/installation/esxi/12.jpg)
...
![screenshot](/img/getting-started/installation/esxi/13.jpg)

:::note
Default port of GNS3 VM is 80.
:::

![screenshot](/img/getting-started/installation/esxi/14.jpg)
