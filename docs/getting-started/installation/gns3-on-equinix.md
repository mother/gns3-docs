...
![screenshot](/img/getting-started/installation/gns3-on-equinix/equinix-metal.png)
...
![screenshot](/img/getting-started/installation/gns3-on-equinix/sign-up.png)
...
![screenshot](/img/getting-started/installation/gns3-on-equinix/equinix-mfa.png)
...
![screenshot](/img/getting-started/installation/gns3-on-equinix/setup-done.png)

Since there currently are no servers provisioned and deployed in your new project, click “Deploy On Demand”:

![screenshot](/img/getting-started/installation/gns3-on-equinix/deploy-servers.png)
...
![screenshot](/img/getting-started/installation/gns3-on-equinix/order.png)
