...
![screenshot](/img/getting-started/installation/mac/4.jpg)

Click on the lock:

![screenshot](/img/getting-started/installation/mac/5.jpg)

Select the **Anywhere** option under **Allow apps downloaded from**:

![screenshot](/img/getting-started/installation/mac/6.jpg)

## Installation of GNS3

Click on the downloaded DMG and drag the **GNS3** icon to the **Applications** folder:

![screenshot](/img/getting-started/installation/mac/7.jpg)
...
![screenshot](/img/getting-started/installation/mac/8.jpg)

If the above security prompt was shown, right click on the GNS3 icon and click on **Open**:

![screenshot](/img/getting-started/installation/mac/9.jpg)
...
![screenshot](/img/getting-started/installation/mac/10.jpg)

You will prompted twice to enter your root password:

![screenshot](/img/getting-started/installation/mac/11.jpg)

## GNS3 Setup Wizard
The GNS3 Setup Wizard will display:

![screenshot](/img/getting-started/installation/mac/12.jpg)
