...
![screenshot](/img/using-gns3/beginners/switching-and-gns3/1.jpg)

Pick **run this IOS image via the local computer**, and click **Next >**:

![screenshot](/img/using-gns3/beginners/switching-and-gns3/2.jpg)
...
![screenshot](/img/using-gns3/beginners/switching-and-gns3/3.jpg)

Select the image file, and click **Open**:  

![screenshot](/img/using-gns3/beginners/switching-and-gns3/4.jpg)
...
![screenshot](/img/using-gns3/beginners/switching-and-gns3/5.jpg)

Click **Next >** to continue:

![screenshot](/img/using-gns3/beginners/switching-and-gns3/6.jpg)
...
![screenshot](/img/using-gns3/beginners/switching-and-gns3/7.jpg)

On the next screen, go ahead and increase the minimum amount of RAM to 256MB, and click **Next >**:

![screenshot](/img/using-gns3/beginners/switching-and-gns3/8.jpg)
...
![screenshot](/img/using-gns3/beginners/switching-and-gns3/9.jpg)
...
![screenshot](/img/using-gns3/beginners/switching-and-gns3/10.jpg)

This device will should already have an Idle-PC value listed. If so, click **Finish**:

![screenshot](/img/using-gns3/beginners/switching-and-gns3/11.jpg)

If the IOS image you are using does not also list an **Idle-PC** value, then click the **Idle-PC finder** button:

![screenshot](/img/using-gns3/beginners/switching-and-gns3/12.jpg)
...
![screenshot](/img/using-gns3/beginners/switching-and-gns3/13.jpg)

Once an Idle-PC value is found, click **OK** to close the pop up window:

![screenshot](/img/using-gns3/beginners/switching-and-gns3/14.jpg)

Click **Finish** to complete the import and set up process:

![screenshot](/img/using-gns3/beginners/switching-and-gns3/15.jpg)

Back at the main **IOS router template** page, ensure that the Etherswitch router has at least **1MB** specified for **PCMCIA disk0**:

![screenshot](/img/using-gns3/beginners/switching-and-gns3/16.jpg)

Click **OK** to return to the main GNS3 GUI:

![screenshot](/img/using-gns3/beginners/switching-and-gns3/17.jpg)
...
![screenshot](/img/using-gns3/beginners/switching-and-gns3/18.jpg)
...
![screenshot](/img/using-gns3/beginners/switching-and-gns3/19.jpg)

Here’s an example of creating vlans 10 and 20 in vlan database:

![screenshot](/img/using-gns3/beginners/switching-and-gns3/20.jpg)

We can’t use the “sh vlan” command, but we can either use the “sh vlan-switch brief” command or the “vl” macro in exec mode:

![screenshot](/img/using-gns3/beginners/switching-and-gns3/21.jpg)
...
![screenshot](/img/using-gns3/beginners/switching-and-gns3/22.jpg)

While “vd [#]” in global config mode will delete a vlan:

![screenshot](/img/using-gns3/beginners/switching-and-gns3/23.jpg)
