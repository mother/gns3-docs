...
![screenshot](/img/using-gns3/beginners/link-control/1.jpg)
![screenshot](/img/using-gns3/beginners/link-control/2.jpg)

As an example, click the **Delay** tab, add a non-zero value for **Latency**, then click **Apply**:

![screenshot](/img/using-gns3/beginners/link-control/3.jpg)

The icon on the **Delay** tab changes from a red square to a green circle, indicating it’s active:

![screenshot](/img/using-gns3/beginners/link-control/4.jpg)

Click **OK** to close the **Packet filters** window:

![screenshot](/img/using-gns3/beginners/link-control/5.jpg)

A filter icon will be displayed on the link to indicate one or more packet filters are active.

![screenshot](/img/using-gns3/beginners/link-control/6.jpg)
...
![screenshot](/img/using-gns3/beginners/link-control/7.jpg)

The link is now suspended, so no traffic can pass through it:

![screenshot](/img/using-gns3/beginners/link-control/8.jpg)
