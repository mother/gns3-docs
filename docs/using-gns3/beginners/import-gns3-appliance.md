...
![screenshot](/img/using-gns3/beginners/import-gns3-appliance/1.jpg)

Navigate to your **Downloads** folder, select the appliance and then click **Open**:

![screenshot](/img/using-gns3/beginners/import-gns3-appliance/2.jpg)
...
![screenshot](/img/using-gns3/beginners/import-gns3-appliance/3.jpg)
...
![screenshot](/img/using-gns3/beginners/import-gns3-appliance/4.jpg)

The Required files window displays:

![screenshot](/img/using-gns3/beginners/import-gns3-appliance/5.jpg)

Select the version of the VM you wish to install, highlight its file name, and click “Import”.

![screenshot](/img/using-gns3/beginners/import-gns3-appliance/6.jpg)
...
![screenshot](/img/using-gns3/beginners/import-gns3-appliance/7.jpg)
...
![screenshot](/img/using-gns3/beginners/import-gns3-appliance/8.jpg)

A confirmation prompt is displayed. Click **Yes** to install the appliance:

![screenshot](/img/using-gns3/beginners/import-gns3-appliance/9.jpg)

A **Usage** screen is displayed. Click **Finish** to complete the appliance addition

![screenshot](/img/using-gns3/beginners/import-gns3-appliance/10.jpg)
...
![screenshot](/img/using-gns3/beginners/import-gns3-appliance/11.jpg)

Click the **Browse all Devices** menu option to view the newly imported GNS3 appliance:

![screenshot](/img/using-gns3/beginners/import-gns3-appliance/12.jpg)
...
![screenshot](/img/using-gns3/beginners/import-gns3-appliance/13.jpg)

Click on the appliance type to view the appliance details:

![screenshot](/img/using-gns3/beginners/import-gns3-appliance/14.jpg)
...
![screenshot](/img/using-gns3/beginners/import-gns3-appliance/15.jpg)
...
![screenshot](/img/using-gns3/beginners/import-gns3-appliance/16.jpg)
...
![screenshot](/img/using-gns3/beginners/import-gns3-appliance/17.jpg)

Once you have created your topology, start the appliance: right click on the appliance and click **Start**):

![screenshot](/img/using-gns3/beginners/import-gns3-appliance/18.jpg)
...
![screenshot](/img/using-gns3/beginners/import-gns3-appliance/19.jpg)
...
![screenshot](/img/using-gns3/beginners/import-gns3-appliance/20.jpg)
