...
![screenshot](/img/using-gns3/beginners/change-node-symbol/1.jpg)

Or in that nodes settings in its global preferences:

![screenshot](/img/using-gns3/beginners/change-node-symbol/2.jpg)
...
![screenshot](/img/using-gns3/beginners/change-node-symbol/3.jpg)
...
![screenshot](/img/using-gns3/beginners/change-node-symbol/4.jpg)

Select a symbol, and click **OK** to have it applied to that device:

![screenshot](/img/using-gns3/beginners/change-node-symbol/5.jpg)

The symbol for R11 has now been changed to “Route Switch Processor”:

![screenshot](/img/using-gns3/beginners/change-node-symbol/6.jpg)
...
![screenshot](/img/using-gns3/beginners/change-node-symbol/7.jpg)

After selecting that symbol, and clicking **OK**, R11 will now use that:

![screenshot](/img/using-gns3/beginners/change-node-symbol/8.jpg)

You can also add a custom symbol from any place in filesystem:

![screenshot](/img/using-gns3/beginners/change-node-symbol/9.jpg)
...
![screenshot](/img/using-gns3/beginners/change-node-symbol/10.jpg)
![screenshot](/img/using-gns3/beginners/change-node-symbol/11.jpg)

Select the SVG file and Click **Open** to add it to the symbol library:

![screenshot](/img/using-gns3/beginners/change-node-symbol/12.jpg)

The symbol for **R11** has changed to **“Linux Guest”**. Click **OK** to complete the process:

![screenshot](/img/using-gns3/beginners/change-node-symbol/13.jpg)

In the main Symbol selection menu, a new **“Custom Symbols”** library is added:

![screenshot](/img/using-gns3/beginners/change-node-symbol/14.jpg)
...
![screenshot](/img/using-gns3/beginners/change-node-symbol/15.jpg)
