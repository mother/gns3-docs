...
![screenshot](/img/using-gns3/advanced/create-a-new-version-for-an-appliance/1.jpg)

Give your version a name

![screenshot](/img/using-gns3/advanced/create-a-new-version-for-an-appliance/2.jpg)

After that, you can import your appliance disk

![screenshot](/img/using-gns3/advanced/create-a-new-version-for-an-appliance/3.jpg)
