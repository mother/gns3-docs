...
![screenshot](/img/using-gns3/advanced/the-nat-node/2.jpg)

The NAT node will appear in the workspace:

![screenshot](/img/using-gns3/advanced/the-nat-node/3.jpg)

Next, the Webterm docker container will also be added to the workspace:

![screenshot](/img/using-gns3/advanced/the-nat-node/4.jpg)

The NAT node has a single interface named nat0:

![screenshot](/img/using-gns3/advanced/the-nat-node/5.jpg)
...
![screenshot](/img/using-gns3/advanced/the-nat-node/6.jpg)
...
![screenshot](/img/using-gns3/advanced/the-nat-node/10.jpg)

Left-clicking on the black background and selecting “Terminal” will open terminal window:

![screenshot](/img/using-gns3/advanced/the-nat-node/11.jpg)
![screenshot](/img/using-gns3/advanced/the-nat-node/12.jpg)
...
![screenshot](/img/using-gns3/advanced/the-nat-node/13.jpg)

Back in Firefox, enter a URL in the address bar, to access a website:

![screenshot](/img/using-gns3/advanced/the-nat-node/14.jpg)
...
![screenshot](/img/using-gns3/advanced/the-nat-node/15.jpg)
...
![screenshot](/img/using-gns3/advanced/the-nat-node/16.jpg)

Entering a URL in the Firefox address bar will open a website:

![screenshot](/img/using-gns3/advanced/the-nat-node/17.jpg)
