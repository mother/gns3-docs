...
![screenshot](../../img/installation/remote-server/1.jpg)
...
- [As the main server (you can have multiple client connected to it)](https://docs.gns3.com/1K_OVfincey0cUw6CP4dWVgs_pBXMdIJ6gdFGjNy8EZQ/index.html)
- [As additional compute resources](https://docs.gns3.com/1xU3oU5dMljU3-wkGPy5-GM4EBlwjrQrlAEEKBotAEmg/index.html)
