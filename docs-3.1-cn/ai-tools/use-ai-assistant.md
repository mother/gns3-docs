...
![整体架构](/img/web-ui/zh/ai-assistant-overview-整体架构.svg)
...
![Agent 工作流](/img/web-ui/zh/ai-assistant-overview-langgraph-agent-工作流.svg)
...
![上下文窗口管理](/img/web-ui/zh/ai-assistant-overview-上下文窗口管理.svg)
