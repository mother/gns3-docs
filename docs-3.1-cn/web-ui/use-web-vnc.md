...
<img style={{ width: '100%' }} alt="右键节点打开 Web VNC" src={useBaseUrl('img/web-ui/zh/web-vnc-right-click-menu.jpeg')} />

Web console(inline) 内联窗口在拓扑界面中，可以拖拽、调整大小、移动、最小化等。

<img style={{ width: '100%' }} alt="Web VNC 内联窗口" src={useBaseUrl('img/web-ui/zh/web-vnc-inline-window.jpeg')} />
