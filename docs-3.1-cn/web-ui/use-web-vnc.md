...
![右键节点打开 Web VNC](/img/web-ui/zh/web-vnc-right-click-menu.jpeg)

Web console(inline) 内联窗口在拓扑界面中，可以拖拽、调整大小、移动、最小化等。

![Web VNC 内联窗口](/img/web-ui/zh/web-vnc-inline-window.jpeg)
...
![VNC连接管理](/img/web-ui/zh/web-vnc-connection.jpeg)
...
![VNC缩放功能](/img/web-ui/zh/web-vnc-zoom.jpeg)
...
![VNC发送按键](/img/web-ui/zh/web-vnc-keys.jpeg)
...
![VNC屏幕截图](/img/web-ui/zh/web-vnc-screenshot.jpeg)
...
![VNC录制模式](/img/web-ui/zh/web-vnc-record.jpeg)
...
![将文本发送到VNC设备](/img/web-ui/zh/web-vnc-clipboard-recv.jpeg)
...
Web VNC 功能由 [YueGuobin](https://github.com/yueguobin) 开发和贡献。
