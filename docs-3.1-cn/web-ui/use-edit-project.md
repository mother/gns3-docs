...
- **项目列表页** — 点击编辑按钮。
<img style={{ display: 'block', margin: '0 auto' }} alt="项目列表编辑按钮" src={useBaseUrl('img/web-ui/zh/edit-project-01-list-page.jpeg')} />

- **拓扑页面** — 点击左上角 logo → Project Settings → Edit Project。
<img style={{ display: 'block', margin: '0 auto' }} alt="拓扑页面菜单" src={useBaseUrl('img/web-ui/zh/edit-project-02-topology-menu.jpeg')} />
...
<img style={{ display: 'block', margin: '0 auto' }} alt="General 标签页" src={useBaseUrl('img/web-ui/zh/edit-project-03-general-tab.jpeg')} />
...
<img style={{ display: 'block', margin: '0 auto' }} alt="Readme 预览模式" src={useBaseUrl('img/web-ui/zh/edit-project-04-readme-edit.jpeg')} />

- 在编辑模式下，可以输入 Markdown 格式文本内容或普通文本，不支持 Mermaid 渲染。停止输入 2 秒后自动保存。

<img style={{ display: 'block', margin: '0 auto' }} alt="Readme 编辑模式" src={useBaseUrl('img/web-ui/zh/edit-project-05-readme-editing.jpeg')} />
...
<img style={{ display: 'block', margin: '0 auto' }} alt="全局变量标签页" src={useBaseUrl('img/web-ui/zh/edit-project-06-global-vars.jpeg')} />
...
<img style={{ display: 'block', margin: '0 auto' }} alt="环境变量结果 1" src={useBaseUrl('img/web-ui/zh/edit-project-09-env-result1.jpeg')} />

<img style={{ display: 'block', margin: '0 auto' }} alt="环境变量结果 2" src={useBaseUrl('img/web-ui/zh/edit-project-10-env-result2.jpeg')} />

<img style={{ display: 'block', margin: '0 auto' }} alt="环境变量结果 3" src={useBaseUrl('img/web-ui/zh/edit-project-11-env-result3.jpeg')} />