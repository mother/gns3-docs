...
1. 点击"VPCS"选项进入。
   <img style={{ width: '100%' }} alt="进入 VPCS" src={useBaseUrl('img/web-ui/zh/vpcs-create-01-enter.jpeg')} />

2. 点击右上角的 + 号按钮添加新模板。
   <img style={{ width: '100%' }} alt="点击添加" src={useBaseUrl('img/web-ui/zh/vpcs-create-02-add.jpeg')} />

3. 输入模板名称（Template Name），点击 "Add Template" 完成创建。
   <img style={{ width: '100%' }} alt="配置模板" src={useBaseUrl('img/web-ui/zh/vpcs-create-03-configure.jpeg')} />

4. 点击右侧的三个点按钮，可以选择删除（Delete）或编辑（Edit）。
   <img style={{ width: '100%' }} alt="操作菜单" src={useBaseUrl('img/web-ui/zh/vpcs-create-04-menu.jpeg')} />
...
<img style={{ width: '100%' }} alt="通用设置" src={useBaseUrl('img/web-ui/zh/vpcs-config-01-general.jpeg')} />
