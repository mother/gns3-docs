...
![右键菜单选择 Packet filters](/img/web-ui/zh/packet-filter-right-click.jpeg)

**步骤 2：选择过滤器类型**

在弹出的 **Packet filters** 对话框中，选择相应的标签页配置过滤器。

![Packet filters 对话框](/img/web-ui/zh/packet-filter-dialog.jpeg)
...
![链路 Packet Filter 图标](/img/web-ui/zh/packet-filter-apply.jpeg)
...
![Reset 按钮](/img/web-ui/zh/packet-filter-reset.jpeg)
